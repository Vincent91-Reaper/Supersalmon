...
from brucelee94.common.aliases import AliasedCommands  # noqa: F401
from brucelee94.common.constants import RE_FEAT  # noqa: F401
from brucelee94.common.figles import (  # noqa: F401
    compress,
    create_relative_path,
    get_audio_files,
)
from brucelee94.common.regexes import (  # noqa: F401
    parse_copyright,
    re_split,
    re_strip,
)
from brucelee94.common.strings import (  # noqa: F401
    fetch_genre,
    less_uppers,
    make_searchstrs,
    normalize_accents,
